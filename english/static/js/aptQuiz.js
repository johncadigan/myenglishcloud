...
(function($){
    $.slickQuiz = function(element, options) {
		...
		form = $('#point-form');
		form.append('<input type="hidden" class="score_holder"name="length" value='+questionCount+'>');
                // Setup questions
		    ...
		    currentQuestion  = questionLI.attr('id').replace(/(question)/, '');
		    ...
		    score *= 100;
                $(targets.quizScore + ' span').html(score + ' out of ' + questionCount*100 + ' points');
