...
<%page args="vocab_items, error, language"/>

<%def name='add_vocab_box(vocab_items, error, language)'>

%if vocab_items:
<div class='bubble-container' id='add-vocab-box'>
	<div class='inside-bubble'>
<form id='Add-Vocab' method=POST action=${request.route_url('submit_flashcards', cid = content['cid'])}>
<fieldset>
%if error:
...
${add_vocab_box(vocab_items, error, language)}
